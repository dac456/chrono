...
class ChApiPostProcess ChPostProcessBase {
  public:
    ...
    virtual void ExportScript(const std::string prefix, const std::string& filename) = 0;
    ...
    /// (Must be implemented by children classes)
    virtual void ExportData(const std::string prefix, const std::string& filename) = 0;
